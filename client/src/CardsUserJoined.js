...
function CardsUserJoined( { group_name, user_id, id, characters, joinedGroupsArray, setJoinedGroupsArray, deleteJoinedGroup } ) {
    return (
        ...
        <div>
            ...
            <ModalLeaveGroup user_id={user_id} id={id} joinedGroupsArray={joinedGroupsArray} setJoinedGroupsArray={setJoinedGroupsArray} deleteJoinedGroup={deleteJoinedGroup} />
        </div>
        </div>
        </Card>
    )
